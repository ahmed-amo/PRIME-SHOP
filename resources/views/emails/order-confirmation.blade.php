              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                ...
                <tbody>
                  ...
                  <tr style="border-bottom:1px solid #f3f4f6;">
                    ...
                    <td style="padding:12px;color:#6b7280;text-align:right;font-size:14px;">{{ Currency::da($item->product_price) }}</td>
                    <td style="padding:12px;color:#111827;font-weight:bold;text-align:right;font-size:14px;">{{ Currency::da($item->quantity * $item->product_price) }}</td>
                  </tr>
                  @endforeach
                </tbody>
                <tfoot>
                  <tr>
                    ...
                    <td style="padding:16px 12px;text-align:right;font-weight:bold;color:#f97316;font-size:18px;">{{ Currency::da($order->total) }}</td>
                  </tr>
                </tfoot>
              </table>
