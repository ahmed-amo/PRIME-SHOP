  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right">{{ Currency::da($item->product_price) }}</td>
        <td class="text-right">{{ Currency::da($item->quantity * $item->product_price) }}</td>
      </tr>
      @endforeach
    </tbody>
    <tfoot>
      <tr class="total-row">
        ...
        <td class="text-right total-amount">{{ Currency::da($order->total) }}</td>
      </tr>
    </tfoot>
  </table>
