...
export default function ShoppingCartSheet({
  ...
  return (
    <>
      ...
      {lastAdded && (
        <div
          className={`fixed bottom-6 right-6 z-[999] w-[92vw] max-w-sm transition-all duration-300 ease-out ${
            toastVisible
          ...
          <div className="bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-semibold text-white truncate">{lastAdded.name}</p>
                <p className="text-xs text-gray-400 mt-0.5">
                  {getItemsCount()} {getItemsCount() === 1 ? "item" : "items"} in bag
                </p>
              </div>
              ...
              <button
                ...
                className="flex items-center gap-1 bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold px-3 py-2 rounded-xl transition-colors flex-shrink-0"
              >
                View bag
