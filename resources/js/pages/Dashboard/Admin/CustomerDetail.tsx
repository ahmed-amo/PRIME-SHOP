          ...
          <CardContent className="pt-4 md:pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl md:text-3xl font-bold text-foreground mt-2">
                  {formatDA(customer.averageOrderValue)}
                </p>
              </div>
                        ...
                        <Table>
                          <TableHeader>
                            <TableRow>
                              ...
                              <TableHead className={isRtl ? "text-left" : "text-right"}>Subtotal</TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {order.items.map((item, idx) => (
                              <TableRow key={idx}>
                                ...
                                <TableCell>{formatDA(item.price)}</TableCell>
                                <TableCell className={`${isRtl ? "text-left" : "text-right"} font-semibold`}>
                                  {formatDA(item.subtotal)}
                                </TableCell>
                              </TableRow>
                            ))}
                          </TableBody>
                      ...
                      <div className="w-full sm:w-64 space-y-2">
                        ...
                        {order.tax > 0 && (
                          <div className="flex justify-between text-sm">
                            ...
                            <span>{formatDA(order.tax)}</span>
                          </div>
                        )}
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">Shipping</span>
                          <span>{formatDA(order.shipping_cost)}</span>
                        </div>
              <Separator />
