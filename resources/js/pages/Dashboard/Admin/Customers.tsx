    ...
    <div dir={direction} className="space-y-6">
      ...
      <div className="relative max-w-md">
        ...
        <Input
          ...
          className={`${isRtl ? "pr-9 text-right" : "pl-9"} h-12 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800`}
        />
      </div>
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <ChevronRight className={`h-5 w-5 text-gray-400 flex-shrink-0 ${isRtl ? "rotate-180" : ""}`} />
                </div>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <div>
                      ...
                      <span className="font-bold text-orange-600">{formatDA(customer.totalSpent)}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
