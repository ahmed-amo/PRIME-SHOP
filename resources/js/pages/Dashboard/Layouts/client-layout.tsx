...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    { name: t("Dashboard"), href: "/client/dashboard", icon: LayoutDashboard },
    { name: t("My Orders"), href: "/client/my-orders", icon: Package },
    { name: t("Wishlist"), href: "/client/wishlist", icon: Heart },
    { name: t("Profile"), href: "/client/profile", icon: UserCog },
  ]
            ...
            <div className="p-6 border-b border-gray-200/50 dark:border-gray-800/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{t("Customer Portal")}</p>
                </div>
              </div>
            </div>
